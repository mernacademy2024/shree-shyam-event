  ...
  return (
    ...
    >
      <div className="absolute inset-0 flex w-full h-full flex-col gap-10 items-center justify-center bg-black bg-opacity-80 text-white">
        ...
        >
          <motion.h1 initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0, transition: { duration: 0.5 } }} viewport={{ once: true }} className="text-white text-2xl italic lg:w-[60vw] text-center">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Similique
            quos dolorum, veritatis officia qui quisquam aliquam tempore soluta
            tempora culpa!
          </motion.h1>

          <motion.h1 initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0, transition: { duration: 1 } }} viewport={{ once: true }} className="text-xl text-zinc-400 italic"> - Pratik Verma</motion.h1>
        </motion.div>
      </div>
    </div>
  );
